...
// NOTE: THIS IS AN ALMOST EXACT COPY OF System.Numerics.Vector3, but renamed to DoubleVector3 and with the float values replaced with double values
// and all Attributes removed, that do not exist in net standard 2.0.
...
namespace System.Numerics.Double
{
    ...
    /// ]]></format></remarks>
    public partial struct DoubleVector3 : IEquatable<DoubleVector3>, IFormattable
    {
        ...
        public DoubleVector3(double value) : this(value, value, value)
        {
        }
        ...
        public DoubleVector3(Vector2 value, double z) : this(value.X, value.Y, z)
        {
        }
        ...
        public DoubleVector3(ReadOnlySpan<double> values)
        {
            if (values.Length < 3)
            {
            ...
            this = Unsafe.ReadUnaligned<DoubleVector3>(ref Unsafe.As<double, byte>(ref MemoryMarshal.GetReference(values)));
        }
        ...
        {
            get => new DoubleVector3(1.0f);
        }

        /// <summary>Gets the vector (1,0,0).</summary>
        /// <value>The vector <c>(1,0,0)</c>.</value>
        public static DoubleVector3 UnitX
        {
            get => new DoubleVector3(1.0f, 0.0f, 0.0f);
        }

        /// <summary>Gets the vector (0,1,0).</summary>
        /// <value>The vector <c>(0,1,0)</c>.</value>
        public static DoubleVector3 UnitY
        {
            get => new DoubleVector3(0.0f, 1.0f, 0.0f);
        }

        /// <summary>Gets the vector (0,0,1).</summary>
        /// <value>The vector <c>(0,0,1)</c>.</value>
        public static DoubleVector3 UnitZ
        {
            get => new DoubleVector3(0.0f, 0.0f, 1.0f);
        }
        ...
        internal static double GetElement(DoubleVector3 vector, int index)
        {
            if ((uint)index >= Count)
            {
        ...
        private static double GetElementUnsafe(ref DoubleVector3 vector, int index)
        {
            Debug.Assert(index >= 0 && index < Count);
            return Unsafe.Add(ref Unsafe.As<DoubleVector3, double>(ref vector), index);
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="index" /> was less than zero or greater than the number of elements.</exception>
        internal static DoubleVector3 WithElement(DoubleVector3 vector, int index, double value)
        {
            if ((uint)index >= Count)
            {
                throw new ArgumentOutOfRangeException(nameof(index));
            ...
            DoubleVector3 result = vector;
            SetElementUnsafe(ref result, index, value);
            return result;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static void SetElementUnsafe(ref DoubleVector3 vector, int index, double value)
        {
            Debug.Assert(index >= 0 && index < Count);
            Unsafe.Add(ref Unsafe.As<DoubleVector3, double>(ref vector), index) = value;
        }
        ...
        /// <remarks>The <see cref="System.Numerics.Vector3.op_Division" /> method defines the division operation for <see cref="System.Numerics.Vector3" /> objects.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 operator /(DoubleVector3 value1, double value2)
        {
            return value1 / new DoubleVector3(value2);
        }
        ...
        /// <remarks>The <see cref="System.Numerics.Vector3.op_Multiply" /> method defines the multiplication operation for <see cref="System.Numerics.Vector3" /> objects.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 operator *(DoubleVector3 left, double right)
        {
        ...
        /// <remarks>The <see cref="System.Numerics.Vector3.op_Multiply" /> method defines the multiplication operation for <see cref="System.Numerics.Vector3" /> objects.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 operator *(double left, DoubleVector3 right)
        {
            return right * left;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Abs(DoubleVector3 value)
        {
            return new DoubleVector3(
                Math.Abs(value.X),
                Math.Abs(value.Y),
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Clamp(DoubleVector3 value1, DoubleVector3 min, DoubleVector3 max)
        {
        ...
        {
            DoubleVector3 difference = value1 - value2;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Divide(DoubleVector3 left, double divisor)
        {
            return left / divisor;
        }
        ...
        /// <returns>The scaled vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Multiply(DoubleVector3 left, double right)
        {
            return left * right;
        }
        ...
        /// <returns>The scaled vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Multiply(double left, DoubleVector3 right)
        {
            return left * right;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 SquareRoot(DoubleVector3 value)
        {
            return new DoubleVector3(
                Math.Sqrt(value.X),
                Math.Sqrt(value.Y),
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Transform(DoubleVector3 position, Matrix4x4 matrix)
        {
            return new DoubleVector3(
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 Transform(DoubleVector3 value, DoubleQuaternion rotation)
        {
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleVector3 TransformNormal(DoubleVector3 normal, Matrix4x4 matrix)
        {
            return new DoubleVector3(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(DoubleVector3 other)
        {
            ...
            static bool SoftwareFallback(in DoubleVector3 self, DoubleVector3 other)
            {
