...
namespace System.Numerics.Double
{
    ...
    [Intrinsic]
#endif
    public struct DoubleMatrix4x4 : IEquatable<DoubleMatrix4x4>
    {
        ...
        public DoubleMatrix4x4(Matrix3x2 value)
        {
            M11 = value.M11;
            M12 = value.M12;
            M13 = 0f;
        ...
        public unsafe double this[int row, int column]
        {
            get
            {
                ...
                DoubleVector4 vrow = Unsafe.Add(ref Unsafe.As<double, DoubleVector4>(ref M11), row);
                return vrow[column];
            }
            set
            {
                ...
                ref DoubleVector4 vrow = ref Unsafe.Add(ref Unsafe.As<double, DoubleVector4>(ref M11), row);
                var tmp = DoubleVector4.WithElement(vrow, column, value);
                vrow = tmp;
            }
        }
        ...
        {
            readonly get => new DoubleVector3(M41, M42, M43);
        ...
        /// <remarks>The <see cref="System.Numerics.DoubleMatrix4x4.op_Addition" /> method defines the operation of the addition operator for <see cref="System.Numerics.DoubleMatrix4x4" /> objects.</remarks>
        public static unsafe DoubleMatrix4x4 operator +(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
        ...
        public static unsafe bool operator ==(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
        ...
        /// <remarks>The <see cref="System.Numerics.DoubleMatrix4x4.op_Multiply" /> method defines the operation of the multiplication operator for <see cref="System.Numerics.DoubleMatrix4x4" /> objects.</remarks>
        public static unsafe DoubleMatrix4x4 operator *(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
            ...
            if (AdvSimd.Arm64.IsSupported)
            {
                Unsafe.SkipInit(out DoubleMatrix4x4 result);

                // Perform the operation on the first row

                Vector128<double> M11 = AdvSimd.LoadVector128(&value1.M11);

                Vector128<double> vX = AdvSimd.MultiplyBySelectedScalar(AdvSimd.LoadVector128(&value2.M11), M11, 0);
                Vector128<double> vY = AdvSimd.MultiplyBySelectedScalar(AdvSimd.LoadVector128(&value2.M21), M11, 1);
                Vector128<double> vZ = AdvSimd.Arm64.FusedMultiplyAddBySelectedScalar(vX, AdvSimd.LoadVector128(&value2.M31), M11, 2);
                Vector128<double> vW = AdvSimd.Arm64.FusedMultiplyAddBySelectedScalar(vY, AdvSimd.LoadVector128(&value2.M41), M11, 3);

                AdvSimd.Store(&result.M11, AdvSimd.Add(vZ, vW));

                // Repeat for the other 3 rows

                Vector128<double> M21 = AdvSimd.LoadVector128(&value1.M21);
                ...
                Vector128<double> M31 = AdvSimd.LoadVector128(&value1.M31);
                ...
                Vector128<double> M41 = AdvSimd.LoadVector128(&value1.M41);
            ...
            {
                Vector128<double> row = Sse.LoadVector128(&value1.M11);
        ...
        /// <remarks>The <see cref="System.Numerics.DoubleMatrix4x4.op_Multiply" /> method defines the operation of the multiplication operator for <see cref="System.Numerics.DoubleMatrix4x4" /> objects.</remarks>
        public static unsafe DoubleMatrix4x4 operator *(DoubleMatrix4x4 value1, double value2)
        {
        ...
        /// <remarks>The <see cref="System.Numerics.DoubleMatrix4x4.op_Subtraction" /> method defines the operation of the subtraction operator for <see cref="System.Numerics.DoubleMatrix4x4" /> objects.</remarks>
        public static unsafe DoubleMatrix4x4 operator -(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
        ...
        public static unsafe DoubleMatrix4x4 operator -(DoubleMatrix4x4 value)
        {
        ...
        public static DoubleMatrix4x4 Add(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
        ...
        public static DoubleMatrix4x4 CreateBillboard(DoubleVector3 objectPosition, DoubleVector3 cameraPosition, DoubleVector3 cameraUpVector, DoubleVector3 cameraForwardVector)
        {
            DoubleVector3 zaxis = objectPosition - cameraPosition;
            ...
            {
                zaxis = DoubleVector3.Multiply(zaxis, 1.0f / Math.Sqrt(norm));
            }

            DoubleVector3 xaxis = DoubleVector3.Normalize(DoubleVector3.Cross(cameraUpVector, zaxis));
            DoubleVector3 yaxis = DoubleVector3.Cross(zaxis, xaxis);

            DoubleMatrix4x4 result;
        ...
        public static DoubleMatrix4x4 CreateConstrainedBillboard(DoubleVector3 objectPosition, DoubleVector3 cameraPosition, DoubleVector3 rotateAxis, DoubleVector3 cameraForwardVector, DoubleVector3 objectForwardVector)
        {
            // Treat the case when object and camera positions are too close.
            DoubleVector3 faceDir = objectPosition - cameraPosition;
            ...
            {
                faceDir = DoubleVector3.Multiply(faceDir, (1.0f / Math.Sqrt(norm)));
            }

            DoubleVector3 yaxis = rotateAxis;
            DoubleVector3 xaxis;
            DoubleVector3 zaxis;

            // Treat the case when angle between faceDir and rotateAxis is too close to 0.
            double dot = DoubleVector3.Dot(rotateAxis, faceDir);
            ...
            if (Math.Abs(dot) > BillboardMinAngle)
            {
                ...
                dot = DoubleVector3.Dot(rotateAxis, zaxis);

                if (Math.Abs(dot) > BillboardMinAngle)
                {
                    zaxis = (Math.Abs(rotateAxis.Z) > BillboardMinAngle) ? new DoubleVector3(1, 0, 0) : new DoubleVector3(0, 0, -1);
                }

                xaxis = DoubleVector3.Normalize(DoubleVector3.Cross(rotateAxis, zaxis));
                zaxis = DoubleVector3.Normalize(DoubleVector3.Cross(xaxis, rotateAxis));
            }
            else
            {
                xaxis = DoubleVector3.Normalize(DoubleVector3.Cross(rotateAxis, faceDir));
                zaxis = DoubleVector3.Normalize(DoubleVector3.Cross(xaxis, yaxis));
            }
        ...
        public static DoubleMatrix4x4 CreateFromAxisAngle(DoubleVector3 axis, double angle)
        {
            // a: angle
            ...
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateFromQuaternion(DoubleQuaternion quaternion)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateFromYawPitchRoll(double yaw, double pitch, double roll)
        {
            DoubleQuaternion q = DoubleQuaternion.CreateFromYawPitchRoll(yaw, pitch, roll);
        ...
        public static DoubleMatrix4x4 CreateLookAt(DoubleVector3 cameraPosition, DoubleVector3 cameraTarget, DoubleVector3 cameraUpVector)
        {
            DoubleVector3 zaxis = DoubleVector3.Normalize(cameraPosition - cameraTarget);
            DoubleVector3 xaxis = DoubleVector3.Normalize(DoubleVector3.Cross(cameraUpVector, zaxis));
            DoubleVector3 yaxis = DoubleVector3.Cross(zaxis, xaxis);
            ...
            result.M41 = -DoubleVector3.Dot(xaxis, cameraPosition);
            result.M42 = -DoubleVector3.Dot(yaxis, cameraPosition);
            result.M43 = -DoubleVector3.Dot(zaxis, cameraPosition);
        ...
        public static DoubleMatrix4x4 CreateOrthographic(double width, double height, double zNearPlane, double zFarPlane)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <param name="zFarPlane">The maximum Z-value of the view volume.</param>
        /// <returns>The orthographic projection matrix.</returns>
        public static DoubleMatrix4x4 CreateOrthographicOffCenter(double left, double right, double bottom, double top, double zNearPlane, double zFarPlane)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        public static DoubleMatrix4x4 CreatePerspective(double width, double height, double nearPlaneDistance, double farPlaneDistance)
        {
            ...
            double negFarRange = double.IsPositiveInfinity(farPlaneDistance) ? -1.0f : farPlaneDistance / (nearPlaneDistance - farPlaneDistance);
        ...
        /// -or-
        /// <paramref name="nearPlaneDistance" /> is greater than or equal to <paramref name="farPlaneDistance" />.</exception>
        public static DoubleMatrix4x4 CreatePerspectiveFieldOfView(double fieldOfView, double aspectRatio, double nearPlaneDistance, double farPlaneDistance)
        {
        ...
        /// -or-
        /// <paramref name="nearPlaneDistance" /> is greater than or equal to <paramref name="farPlaneDistance" />.</exception>
        public static DoubleMatrix4x4 CreatePerspectiveOffCenter(double left, double right, double bottom, double top, double nearPlaneDistance, double farPlaneDistance)
        {
            if (nearPlaneDistance <= 0.0f)
                throw new ArgumentOutOfRangeException(nameof(nearPlaneDistance));
        ...
        public static DoubleMatrix4x4 CreateReflection(Plane value)
        {
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationX(double radians)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationX(double radians, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationY(double radians)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationY(double radians, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationZ(double radians)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The rotation matrix.</returns>
        public static DoubleMatrix4x4 CreateRotationZ(double radians, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        public static DoubleMatrix4x4 CreateScale(double xScale, double yScale, double zScale)
        {
            DoubleMatrix4x4 result = Identity;
            result.M11 = xScale;
            result.M22 = yScale;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static DoubleMatrix4x4 CreateScale(double xScale, double yScale, double zScale, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The scaling matrix.</returns>
        public static DoubleMatrix4x4 CreateScale(DoubleVector3 scales)
        {
            DoubleMatrix4x4 result = Identity;
            result.M11 = scales.X;
            result.M22 = scales.Y;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static DoubleMatrix4x4 CreateScale(DoubleVector3 scales, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The scaling matrix.</returns>
        public static DoubleMatrix4x4 CreateScale(double scale)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static DoubleMatrix4x4 CreateScale(double scale, DoubleVector3 centerPoint)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        public static DoubleMatrix4x4 CreateShadow(DoubleVector3 lightDirection, Plane plane)
        {
        ...
        public static DoubleMatrix4x4 CreateTranslation(DoubleVector3 position)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        /// <returns>The translation matrix.</returns>
        public static DoubleMatrix4x4 CreateTranslation(double xPosition, double yPosition, double zPosition)
        {
            DoubleMatrix4x4 result = Identity;
        ...
        public static DoubleMatrix4x4 CreateWorld(DoubleVector3 position, DoubleVector3 forward, DoubleVector3 up)
        {
            DoubleVector3 zaxis = DoubleVector3.Normalize(-forward);
            DoubleVector3 xaxis = DoubleVector3.Normalize(DoubleVector3.Cross(up, zaxis));
            DoubleVector3 yaxis = DoubleVector3.Cross(zaxis, xaxis);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool Invert(DoubleMatrix4x4 matrix, out DoubleMatrix4x4 result)
        {
...
#if NET5_0_OR_GREATER
            static unsafe bool SseImpl(DoubleMatrix4x4 matrix, out DoubleMatrix4x4 result)
            {
                if (!Sse.IsSupported)
                {
                ...
                Vector128<double> row1 = Sse.LoadVector128(&matrix.M11);
                Vector128<double> row2 = Sse.LoadVector128(&matrix.M21);
                Vector128<double> row3 = Sse.LoadVector128(&matrix.M31);
                Vector128<double> row4 = Sse.LoadVector128(&matrix.M41);

                // Transpose the matrix
                Vector128<double> vTemp1 = Sse.Shuffle(row1, row2, 0x44); //_MM_SHUFFLE(1, 0, 1, 0)
                Vector128<double> vTemp3 = Sse.Shuffle(row1, row2, 0xEE); //_MM_SHUFFLE(3, 2, 3, 2)
                Vector128<double> vTemp2 = Sse.Shuffle(row3, row4, 0x44); //_MM_SHUFFLE(1, 0, 1, 0)
                Vector128<double> vTemp4 = Sse.Shuffle(row3, row4, 0xEE); //_MM_SHUFFLE(3, 2, 3, 2)
                ...
                Vector128<double> V00 = Permute(row3, 0x50);           //_MM_SHUFFLE(1, 1, 0, 0)
                Vector128<double> V10 = Permute(row4, 0xEE);           //_MM_SHUFFLE(3, 2, 3, 2)
                Vector128<double> V01 = Permute(row1, 0x50);           //_MM_SHUFFLE(1, 1, 0, 0)
                Vector128<double> V11 = Permute(row2, 0xEE);           //_MM_SHUFFLE(3, 2, 3, 2)
                Vector128<double> V02 = Sse.Shuffle(row3, row1, 0x88); //_MM_SHUFFLE(2, 0, 2, 0)
                Vector128<double> V12 = Sse.Shuffle(row4, row2, 0xDD); //_MM_SHUFFLE(3, 1, 3, 1)

                Vector128<double> D0 = Sse.Multiply(V00, V10);
                Vector128<double> D1 = Sse.Multiply(V01, V11);
                Vector128<double> D2 = Sse.Multiply(V02, V12);
                ...
                // V13 = D1Y,D1W,D2W,D2W
                Vector128<double> V13 = Sse.Shuffle(D1, D2, 0xFD); //_MM_SHUFFLE(3, 3, 3, 1)
                V02 = Permute(row4, 0x49);                        //_MM_SHUFFLE(1, 0, 2, 1)
                V12 = Sse.Shuffle(V13, D1, 0x32);                 //_MM_SHUFFLE(0, 3, 0, 2)
                Vector128<double> V03 = Permute(row3, 0x12);       //_MM_SHUFFLE(0, 1, 0, 2)
                V13 = Sse.Shuffle(V13, D1, 0x99);                 //_MM_SHUFFLE(2, 1, 2, 1)

                Vector128<double> C0 = Sse.Multiply(V00, V10);
                Vector128<double> C2 = Sse.Multiply(V01, V11);
                Vector128<double> C4 = Sse.Multiply(V02, V12);
                Vector128<double> C6 = Sse.Multiply(V03, V13);
                ...
                Vector128<double> C1 = Sse.Subtract(C0, V00);
                C0 = Sse.Add(C0, V00);
                Vector128<double> C3 = Sse.Add(C2, V01);
                C2 = Sse.Subtract(C2, V01);
                Vector128<double> C5 = Sse.Subtract(C4, V02);
                C4 = Sse.Add(C4, V02);
                Vector128<double> C7 = Sse.Add(C6, V03);
                ...
                // Get the determinant
                vTemp2 = row1;
                double det = DoubleVector4.Dot(C0.AsVector4(), vTemp2.AsVector4());

                // Check determinate is not zero
                if (Math.Abs(det) < double.Epsilon)
                {
                    result = new DoubleMatrix4x4(double.NaN, double.NaN, double.NaN, double.NaN,
                ...
                // Create Vector128<double> copy of the determinant and invert them.
                Vector128<double> ones = Vector128.Create(1.0f);
                Vector128<double> vTemp = Vector128.Create(det);
                ...
                ref Vector128<double> vResult = ref Unsafe.As<DoubleMatrix4x4, Vector128<double>>(ref result);
...
#endif
            static bool SoftwareFallback(DoubleMatrix4x4 matrix, out DoubleMatrix4x4 result)
            {
                //                                       -1
        ...
        /// <returns>The product matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleMatrix4x4 Multiply(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
            return value1 * value2;
        }
        ...
        /// <returns>The scaled matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleMatrix4x4 Multiply(DoubleMatrix4x4 value1, double value2)
        {
            return value1 * value2;
        }
        ...
        /// <returns>The negated matrix.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleMatrix4x4 Negate(DoubleMatrix4x4 value)
        {
            return -value;
        }
        ...
        /// <returns>The matrix containing the values that result from subtracting each element in <paramref name="value2" /> from its corresponding element in <paramref name="value1" />.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DoubleMatrix4x4 Subtract(DoubleMatrix4x4 value1, DoubleMatrix4x4 value2)
        {
            return value1 - value2;
        }
...
#if NET5_0_OR_GREATER
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static Vector128<double> Permute(Vector128<double> value, byte control)
        {
        ...
        public static bool Decompose(DoubleMatrix4x4 matrix, out DoubleVector3 scale, out DoubleQuaternion rotation, out DoubleVector3 translation)
        {
            bool result = true;

            unsafe
            {
                fixed (DoubleVector3* scaleBase = &scale)
                {
                    double* pfScales = (double*)scaleBase;
                    double det;

                    VectorBasis vectorBasis;
                    DoubleVector3** pVectorBasis = (DoubleVector3**)&vectorBasis;

                    DoubleMatrix4x4 matTemp = Identity;
                    CanonicalBasis canonicalBasis = default;
                    DoubleVector3* pCanonicalBasis = &canonicalBasis.Row0;

                    canonicalBasis.Row0 = new DoubleVector3(1.0f, 0.0f, 0.0f);
                    canonicalBasis.Row1 = new DoubleVector3(0.0f, 1.0f, 0.0f);
                    canonicalBasis.Row2 = new DoubleVector3(0.0f, 0.0f, 1.0f);

                    translation = new DoubleVector3(
                        matrix.M41,
                        matrix.M42,
                        matrix.M43);

                    pVectorBasis[0] = (DoubleVector3*)&matTemp.M11;
                    pVectorBasis[1] = (DoubleVector3*)&matTemp.M21;
                    pVectorBasis[2] = (DoubleVector3*)&matTemp.M31;

                    *(pVectorBasis[0]) = new DoubleVector3(matrix.M11, matrix.M12, matrix.M13);
                    *(pVectorBasis[1]) = new DoubleVector3(matrix.M21, matrix.M22, matrix.M23);
                    *(pVectorBasis[2]) = new DoubleVector3(matrix.M31, matrix.M32, matrix.M33);
                    ...
                    *pVectorBasis[a] = DoubleVector3.Normalize(*pVectorBasis[a]);
                    ...
                    if (pfScales[b] < DecomposeEpsilon)
                    {
                        ...
                        *pVectorBasis[b] = DoubleVector3.Cross(*pVectorBasis[a], *(pCanonicalBasis + cc));
                    }

                    *pVectorBasis[b] = DoubleVector3.Normalize(*pVectorBasis[b]);

                    if (pfScales[c] < DecomposeEpsilon)
                    {
                        *pVectorBasis[c] = DoubleVector3.Cross(*pVectorBasis[a], *pVectorBasis[b]);
                    }

                    *pVectorBasis[c] = DoubleVector3.Normalize(*pVectorBasis[c]);
                    ...
                    else
                    {
                        ...
                        rotation = DoubleQuaternion.CreateFromRotationMatrix(matTemp);
                    }
                }
            }
        ...
        public static unsafe DoubleMatrix4x4 Lerp(DoubleMatrix4x4 matrix1, DoubleMatrix4x4 matrix2, double amount)
        {
        ...
        public static DoubleMatrix4x4 Transform(DoubleMatrix4x4 value, DoubleQuaternion rotation)
        {
        ...
        public static unsafe DoubleMatrix4x4 Transpose(DoubleMatrix4x4 matrix)
        {
            ...
            if (AdvSimd.Arm64.IsSupported)
            {
                ...
                Vector128<double> M11 = AdvSimd.LoadVector128(&matrix.M11);
                Vector128<double> M31 = AdvSimd.LoadVector128(&matrix.M31);

                Vector128<double> P00 = AdvSimd.Arm64.ZipLow(M11, M31);
                Vector128<double> P01 = AdvSimd.Arm64.ZipHigh(M11, M31);

                Vector128<double> M21 = AdvSimd.LoadVector128(&matrix.M21);
                Vector128<double> M41 = AdvSimd.LoadVector128(&matrix.M41);

                Vector128<double> P10 = AdvSimd.Arm64.ZipLow(M21, M41);
                Vector128<double> P11 = AdvSimd.Arm64.ZipHigh(M21, M41);
            ...
            else if (Sse.IsSupported)
            {
                ...
                Vector128<double> l12 = Sse.UnpackLow(row1, row2);
                Vector128<double> l34 = Sse.UnpackLow(row3, row4);
                Vector128<double> h12 = Sse.UnpackHigh(row1, row2);
                Vector128<double> h34 = Sse.UnpackHigh(row3, row4);
        ...
        /// <remarks>The current instance and <paramref name="obj" /> are equal if <paramref name="obj" /> is a <see cref="System.Numerics.DoubleMatrix4x4" /> object and the corresponding elements of each matrix are equal.</remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override readonly bool Equals(object? obj)
        {
            return (obj is DoubleMatrix4x4 other) && Equals(other);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(DoubleMatrix4x4 other)
        {
            ...
            static bool SoftwareFallback(in DoubleMatrix4x4 self, DoubleMatrix4x4 other)
            {
        ...
        {
            public DoubleVector3 Row0;
            public DoubleVector3 Row1;
            public DoubleVector3 Row2;
        };

        private struct VectorBasis
        {
            public unsafe DoubleVector3* Element0;
            public unsafe DoubleVector3* Element1;
            public unsafe DoubleVector3* Element2;
        }
    }
}